...
import { Bitmap, Canvas, Grid, Renderer, TransformTarget } from "../interface.js";
...
export class WebGLRenderer implements Renderer {
    ...
    constructor(canvasWidth : number | undefined, canvasHeight : number | undefined, 
        ...
        this.canvas = new WebGLCanvas(this, this.canvasTransform, this.gl, canvasWidth, canvasHeight);
    ...
    public createGrid(layers : number[][], width : number, height : number, flatten : boolean = false) : Grid {
        ...
        const out : Grid = new WebGLGrid(this.gl, layers, width, height);
